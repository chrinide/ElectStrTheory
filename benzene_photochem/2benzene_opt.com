***, benz CAS(6e,6o) geometry optimization, initial geometry from B3LYP/6-31G** calculation
file,2,benz_gs.wfu  ! save orbs must include the -W option in the molpro command
symmetry,nosym
memory,400,m
orient,noorient
...
{HF;
orbital,2100.2}                    ! do hartree fock calculation
